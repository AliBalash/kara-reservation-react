  ...
  return (
    <footer className="kara-footer">
      <div className="kara-footer__inner">
        <div><img src="/kara-plus-logo.png" alt="Kara Plus Rent a Car" width="1536" height="1024" /><p>Premium car rental in Dubai with transparent pricing and personal support.</p></div>
